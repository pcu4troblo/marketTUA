...
let BuscarItemsComponent = class BuscarItemsComponent {
    constructor() {
        this.carrito = [];
    }
    ngOnInit() {
...
let DetalleCarritoComponent = class DetalleCarritoComponent {
    constructor(router) {
        this.router = router;
        this.carrito = [];
        this.suma = 0;
...
DetalleCarritoComponent.ctorParameters = () => [
...
let DetalleItemComponent = class DetalleItemComponent {
...
DetalleItemComponent.ctorParameters = () => [
...
ContenidoComponent.ctorParameters = () => [
    { type: src_app_services_items_service__WEBPACK_IMPORTED_MODULE_2__["ItemsService"] },
...
let FiltroComponent = class FiltroComponent {
    constructor() {
        this.listItems = [];
    }
    ngOnInit() {
